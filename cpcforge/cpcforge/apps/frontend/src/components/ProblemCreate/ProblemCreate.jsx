...
import { api, getTokenStatus, getPlatformTokenStatus, navigateAndRefresh } from '../../utils';
import styles from './ProblemCreate.module.scss';
...
function ProblemCreate() {
    ...
    const { handle: pltHandle } = useParams();
    ...
    const probcreateSubmitEvent = async (values, actions) => {
        console.log("prob create", values);
